      ...
      <section className="bg-paper py-20 text-ink md:py-28">
        <div className="container-x grid gap-14 lg:grid-cols-[1fr_1.25fr] lg:items-start">
          <div className="reveal">
            <ul className="space-y-4">
              {contactPage.reassurance.map((item) => (
                <li key={item} className="flex items-start gap-3.5 text-[1.02rem] leading-relaxed">
                  <span
                    aria-hidden="true"
                    className="mt-0.5 flex h-6 w-6 flex-none items-center justify-center border border-accent text-[0.8rem] text-accent"
                  >
                    ✓
                  </span>
                  {item}
            ...
            <p className="mt-9 max-w-[26em] border-r-[3px] border-accent pr-6 font-display text-[1.25rem] leading-snug text-ink">
              ...
              <dl className="mt-10 grid gap-px border border-paper-line bg-paper-line">
                {phone && (
                  <div className="bg-paper-2 px-6 py-5">
                    <dt className="font-mono text-[0.6rem] tracking-[0.13em] text-ink/50">טלפון</dt>
                ...
                {email && (
                  <div className="bg-paper-2 px-6 py-5">
                    <dt className="font-mono text-[0.6rem] tracking-[0.13em] text-ink/50">אימייל</dt>
                    <dd className="mt-1.5 text-[1.05rem] font-semibold">
                ...
                {whatsapp && (
                  <div className="bg-paper-2 px-6 py-5">
                    <dt className="font-mono text-[0.6rem] tracking-[0.13em] text-ink/50">וואטסאפ</dt>
                    <dd className="mt-1.5 text-[1.05rem] font-semibold">
